...
class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context, TypedArray typedArray) {
        ...
        mCurrentDayTextColor = typedArray.getColor(R.styleable.DayPickerView_colorCurrentDay, resources.getColor(R.color.color_272C32));
        mMonthTextColor = typedArray.getColor(R.styleable.DayPickerView_colorMonthName, resources.getColor(R.color.color_272C32));
        mDayTextColor = typedArray.getColor(R.styleable.DayPickerView_colorDayName, resources.getColor(R.color.color_272C32));
        mDayNumColor = typedArray.getColor(R.styleable.DayPickerView_colorNormalDay, resources.getColor(R.color.color_272C32));
        mPreviousDayColor = typedArray.getColor(R.styleable.DayPickerView_colorPreviousDay, resources.getColor(R.color.color_272C32));
        mSelectedDaysColor = typedArray.getColor(R.styleable.DayPickerView_colorSelectedDayBackground, resources.getColor(R.color.color_0078FF));
    ...
    protected void drawMonthNums(Canvas canvas) {
        ...
        while (day <= mNumCells) {
            ...
            if ((mMonth == mSelectedBeginMonth && mSelectedBeginDay == day && mSelectedBeginYear == mYear) ||
                ...
                if (mDrawRect) {
                    RectF rectF = new RectF(x - DAY_SELECTED_CIRCLE_SIZE * 1.7f, (y - MINI_DAY_NUMBER_TEXT_SIZE / 3) - DAY_SELECTED_CIRCLE_SIZE,
                            x + DAY_SELECTED_CIRCLE_SIZE * 1.7f, (y - MINI_DAY_NUMBER_TEXT_SIZE / 3) + DAY_SELECTED_CIRCLE_SIZE);
...
//                mMonthNumPaint.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
            ...
            if ((mSelectedBeginDay != -1 && mSelectedLastDay != -1 && mSelectedBeginYear == mSelectedLastYear &&
                ...
                mMonthNumPaint.setColor(ContextCompat.getColor(getContext(),R.color.color_ffffff));
//                drawSelectBg(canvas, x);
...
//                mMonthNumPaint.setTypeface(Typeface.defaultFromStyle(Typeface.ITALIC));
            ...
            if (isInSelectRange && !isSingleChoose) {
                RectF rectF = new RectF(x - DAY_SELECTED_CIRCLE_SIZE * 2, (y - MINI_DAY_NUMBER_TEXT_SIZE / 3) - DAY_SELECTED_CIRCLE_SIZE,
                        x + DAY_SELECTED_CIRCLE_SIZE * 2, (y - MINI_DAY_NUMBER_TEXT_SIZE / 3) + DAY_SELECTED_CIRCLE_SIZE);
                mSelectedRangePaint.setColor(ContextCompat.getColor(getContext(), R.color.color_E8ECF2));
                canvas.drawRoundRect(rectF, 10.0f, 10.0f, mSelectedRangePaint);
            }
...
//        drawMonthDayLabels(canvas);
    ...
    public void setSingleChoose(boolean isSingleChoose) {
